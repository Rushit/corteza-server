...
// GatewayPath validates expression and returns initialized gatewayPath
func GatewayPath(s Step, expr string) (gwp *gatewayPath, err error) {
...
//
// Join gateways is ready to continue with the workflow when all configured paths are ready to be joined
...
// No arguments are required; workflow graph config is used to
...
// This signals workflow executor to collect child nodes directly caller workflow
